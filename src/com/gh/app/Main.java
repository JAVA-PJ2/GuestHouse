...
public class Main {
	...
	public static void main(String[] args) {
		...
		gh.add(new MusicGH("GH002", "뮤직존 스튜디오2", "음악", 120.0, 5, 0, "방음 완비, 드럼/기타 보유", true, true, true));
		gh.add(new PetGH("GH003", "펫팰리스 도그하우스", "반려견", 80.0, 3, 0, "중형견 전용, 응급대응 지원", 30.0, null, true));
		gh.add(new PetGH("GH004", "펫팰리스 캣하우스", "반려묘", 75.0, 2, 0, "고양이 전용, 조용한 실내", 25.0, null, false));
		gh.add(new PartyGH("GH005", LocalDate.now(), LocalDate.now().plusDays(1), 1, 1, null, "파티존 루프탑", "파티", 150.0,
				10, 0, "루프탑 파티 공간, DJ 부스 완비", 19));
		gh.add(new PartyGH("GH006", LocalDate.now(), LocalDate.now().plusDays(1), 1, 1, null, "파티존 루프탑", "파티", 160.0,
				10, 0, "루프탑 파티 공간, DJ 부스 완비", 19));
		gh.add(new Guesthouse("GH007", "일반 게스트하우스", "일반", 50.0, 4, 0, "저렴하고 깨끗한 일반 숙소"));
