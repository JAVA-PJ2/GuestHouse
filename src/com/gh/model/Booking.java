...
/**
 * 게스트하우스 예약 정보를 담는 클래스입니다. 예약 ID, 시작일, 종료일, 숙박일수, 인원 수, 숙소 정보(Has a)를 포함합니다.
 * 
 * <p>
...
public class Booking {
	...
	/**
	 * 기본 생성자입니다. 기본값으로 오늘 날짜를 시작일로 하고, 1박 1인 기준으로 예약을 생성합니다.
	 */
	public Booking() {
	...
	/**
	 * 예약 시작일을 설정합니다. 예약 시작일과 동시에 endDate도 설정한다.
	 * 
	 * @param startDate
	 */
	...
	/**
	 * 예약 ID를 수동으로 설정합니다. 주의: 일반적으로는 UUID로 자동 생성되므로 수동 설정은 지양해야 합니다.
	 *
