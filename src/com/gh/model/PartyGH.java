...
public class PartyGH extends Guesthouse {
	 ...
	 */
	public PartyGH(String bookingId, LocalDate startDate, LocalDate endDate, int bookingDays, int numberOfPeople,
			Guesthouse guesthouse, String name, String type, double pricePerDays, int maxPeople, int currentPeople,
